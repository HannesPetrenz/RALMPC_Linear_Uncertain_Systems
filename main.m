...
%   Copyright Notice
%   ----------------
%   All rights to this script and its associated methods, algorithms, and 
%   implementations are reserved by Hannes Petrenz and University of 
%   California, Berkeley. 
%   This script is provided for academic and research purposes only. 
%   Commercial use of this script without explicit permission is prohibited.
%
